...
public class InverseIndexSecond {
    ...
    static class InverseIndexMapper extends Mapper<LongWritable,Text,Text,Text> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
              ...
              String word = tokens1[0];
              String filename = tokens1[1];

              String fileNameWordCount = filename+"--->"+tokens[1];

              context.write(new Text(word),new Text(fileNameWordCount));
        }
    }
    ...
    static class InverseIndexReducer extends Reducer<Text,Text,Text,Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
              ...
              String completedFileNameWordCount = "";
              for(Text fileNameWordCount:values){
                  completedFileNameWordCount += fileNameWordCount+"\t";
              }
              context.write(key,new Text(completedFileNameWordCount));
        }
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        FileInputFormat.setInputPaths(job,new Path("D:/mapreduceTest/output6/"));
        FileOutputFormat.setOutputPath(job,new Path("D:/mapreduceTest/output7/"));
